 ...
 * @since 2022-08-18
 */
public class TankDirectionChangedMsg extends Msg {
    public UUID id;
    public int x, y;
    public DirectionEnum directionEnum;


    public TankDirectionChangedMsg(BaseTank baseTank) {
    ...
    public TankDirectionChangedMsg(int x, int y, DirectionEnum directionEnum, UUID id) {
        this.id = id;
        this.x = x;
        this.y = y;
    ...
    public TankDirectionChangedMsg() {
    }
    ...
    public MsgEnum getMsgEnum() {
        return MsgEnum.TANK_DIRECTION_CHANGED;
    }
